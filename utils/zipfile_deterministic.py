...
def _EndRecData64(fpin, offset, endrec):
    ...
    if len(data) != sizeEndCentDir64:
        return endrec
    sig, sz, create_version, read_version, disk_num, disk_dir, dircount, dircount2, dirsize, diroffset = struct.unpack(
...
class ZipFile:
    ...
    def _open_to_write(self, zinfo, force_zip64=False):
        ...
        zip64 = self._allowZip64 and (force_zip64
                                      or zinfo.file_size * 1.05 > ZIP64_LIMIT)
    ...
    def _extract_member(self, member, targetpath, pwd):
        ...
        with self.open(member, pwd=pwd) as source, open(targetpath,
                                                        "wb") as target:
    ...
    def write_from_directory(self,
        ...
        for root, subfolders, files in os.walk(directory):
            ...
            path_nested = [
                os.path.join(*path_fragments[:x + 1])
                for x, _ in enumerate(path_fragments)
            ]
